 ...
 * @status: current
 * @updated: 2026-01-11
 * @tags: [landing-page, marketing, hero, features, pricing, testimonial, conversion, a-b-test]
 * @related: [page.tsx, button.tsx, auth/login/page.tsx, corner-brackets.tsx, marketing-copy.ts]
 * @priority: high
 * @complexity: high
 * @dependencies: [react, next/link, heroicons, ui/button, ui/corner-brackets, config/marketing-copy]
 */
'use client'
          ...
          <div className="max-w-2xl mx-auto">
            <CornerBrackets corners="all" className="bg-card border border-border rounded-lg p-8 md:p-12 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/auth/signup" onClick={() => handleCTAClick('primary', 'footer')}>
                  <Button size="lg" className="w-full sm:w-auto">
                    Get Started Free
                    <ArrowRightIcon className="ml-2 h-4 w-4" />
                  </Button>
                </Link>
                <Link href="https://docs.ginko.ai" target="_blank" onClick={() => handleCTAClick('secondary', 'footer')}>
